...
class OfferCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          _buildHeader(tr, order, remaining),
          _buildBody(tr, order),
        ],
      ),
    );
  ...
  Widget _buildHeader(AppLocalizations tr, var order, int remaining) {
    return Container(
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text(
                      order.distance != null 
                          ? '${order.distance!.toStringAsFixed(1)} ${tr.t('km')}'
                          : '? ${tr.t('km')}',
                      style: const TextStyle(
                        color: Colors.white70,
                        fontSize: 13,
  ...
  Widget _buildBody(AppLocalizations tr, var order) {
    return Padding(
      padding: const EdgeInsets.all(16),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
